...
function ihc_init(){
	...
	if (!empty($_POST['ihcaction']) && $_POST['ihcaction'] !== 'login' ){ // adding && $_POST['ihcaction'] !== 'login' since 13.1
		...
		/// login check - since 13.1
		if (!empty($_POST['ihcaction']) && $_POST['ihcaction'] === 'login' ){
			ihc_init_form_action($url);
		}
		// end of login - since 13.1
