...
$fields = array_flip( get_option( 'qlwcdc_add_checkout_cart_fields', false ) );
?>
<?php if ( $fields ) : ?>
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-remove">
								<?php printf( '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s">&times;</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'woocommerce' ), esc_attr( $_product->get_id() ), esc_attr( $_product->get_sku() ), $cart_item_key ); ?>
						</td>
						<?php endif; ?>
							<?php if ( isset( $fields['thumbnail'] ) ) : ?>
