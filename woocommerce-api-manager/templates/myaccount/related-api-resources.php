...
<table class="shop_table shop_table_responsive my_account_orders woocommerce-orders-table">
	<thead>
	<tr>
		<th class="order-number woocommerce-orders-table__header woocommerce-orders-table__header-order-number"><span class="nobr"><?php echo esc_html( apply_filters( 'wc_api_manager_related_api_resources_api_keys_heading', __( 'API Keys', 'woocommerce-api-manager' ) ) ); ?></span></th>
		<th class="order-number woocommerce-orders-table__header woocommerce-orders-table__header-order-number"><span class="nobr"><?php echo esc_html( apply_filters( 'wc_api_manager_related_api_resources_api_downloads_heading', __( 'API Downloads', 'woocommerce-api-manager' ) ) ); ?></span></th>
	</tr>
	</thead>
	<tbody>
