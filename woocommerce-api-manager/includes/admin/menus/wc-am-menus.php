...
class WC_AM_Menus {
	...
	public function __construct() {
		add_action( 'admin_menu', [ $this, 'menus' ], 9 );
	...
	public function menus() {
		...
		$this->api_manager_customers = add_submenu_page( 'wcam_api_manager_customers', __( 'API Customers', 'woocommerce-api-manager' ), __( 'API Customers', 'woocommerce-api-manager' ), 'manage_options', 'wcam_api_manager_customers', [
			$this,
			'customers_page',
		] );

		add_action( 'load-' . $this->api_manager_customers, [ $this, 'add_screen_options' ] );
	}
