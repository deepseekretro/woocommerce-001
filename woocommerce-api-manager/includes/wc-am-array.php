...
class WC_AM_Array {
	...
	public function array_remove_duplicate_by_key( $array, $key, $sort = '' ) {
		$unique_array      = []; // The results will be loaded into this array.
		$unique_index_keys = []; // The list of keys will be added here.
		...
		if ( $sort == 'uasort' ) { // Sort an array with a user-defined comparison function and maintain index association
			...
			uasort( $unique_array, [ $this, 'array_compare_by_key' ] );
		}
	...
	public function array_uasort_by_key( $array, $key ) {
		...
		uasort( $array, [ $this, 'array_compare_by_key' ] );
