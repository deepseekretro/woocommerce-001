...
class WC_AM_Legacy_Product_ID_Data_Store {
	...
	public function has_legacy_product_id( $product_id_title ) {
		...
		return ! WC_AM_FORMAT()->empty( $wpdb->get_var( $wpdb->prepare( $sql, $product_id_title ) ) ); // phpcs:ignore
	}
	...
	public function has_legacy_product_id_title( $product_id_integer ) {
		...
		return ! WC_AM_FORMAT()->empty( $wpdb->get_var( $wpdb->prepare( $sql, $product_id_integer ) ) ); // phpcs:ignore
	}
	...
	public function get_product_id_title( $product_id_integer, $key = '_api_resource_title' ) {
		...
		$product_id_title = $wpdb->get_var( $wpdb->prepare( $sql, $product_id_integer ) ); // phpcs:ignore
	...
	public function get_product_id_integer( $product_id_title, $key = '_api_resource_title' ) {
		...
		$product_id_integer = $wpdb->get_var( $wpdb->prepare( $sql, $product_id_title ) ); // phpcs:ignore
