...
class WC_AM_User {
	...
	private function __construct() {
		...
		add_action( 'user_register', [ $this, 'set_registration_master_key_and_status' ], 10, 1 );
		// Delete Master API Keys and status when user deleted.
		add_action( 'delete_user', [ $this, 'delete_master_key_and_status' ], 10, 2 );
		add_action( 'show_user_profile', [ $this, 'add_api_key_fields' ] );
		add_action( 'edit_user_profile', [ $this, 'add_api_key_fields' ] );
		add_action( 'personal_options_update', [ $this, 'set_key_and_status' ] );
		add_action( 'edit_user_profile_update', [ $this, 'set_key_and_status' ] );
	}
