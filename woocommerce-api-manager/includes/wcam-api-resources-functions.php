 ...
 * @param int      $product_id the product ID associated with the API resources
 * @param int|null $parent_product_id optional parent product ID
 * @return array|bool
 * @throws \Exception
 */
function wc_am_get_all_active_api_resources_for_api_key_by_product_id( $api_key, $product_id, ?int $parent_product_id = null ) {
	return WC_AM_API_RESOURCE_DATA_STORE()->get_active_api_resources( $api_key, $product_id, $parent_product_id );
}
