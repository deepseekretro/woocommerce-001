...
if (!class_exists('ARM_Admin_mycred_feature'))
{
    class ARM_Admin_mycred_feature 
    {
        ...
        ?>
            ...
            <tr class="form-field">
                <th class="arm-form-table-label"><label><?php echo sprintf(esc_html__('%d Point', 'ARMember'), 1);//phpcs:ignore?> = </label></th>
                <td class="arm-form-table-content">
                    <input type="text" class="arm_active_payment_<?php echo esc_attr(strtolower($gateway_name));?>" id="arm_mycred_point_exchange" name="payment_gateway_settings[mycred][point_exchange]" value="<?php echo esc_attr($point_exchange); ?>">
                </td>
            </tr>
        <?php
            }
