...
if (!class_exists('ARM_membership_setup')) {
    ...
    class ARM_membership_setup {
        ...
        function arm_setup_form_styling_additional_fields_func($arm_setup_additional_form_fields,$setup_data,$setup_modules){
            ...
            $arm_setup_additional_form_fields = '<div class="arm_setup_option_field">
                ...
                <div class="arm_setup_option_input">
                    ...
                    <div class="arm_setup_option_field">
                        ...
                        <div class="arm_setup_option_input">
                            ...
                            <div class="arm_font_style_options">
                                <label class="arm_font_style_label '.$arm_setup_title_font_bold_class.'" data-value="bold" data-field="arm_setup_title_font_bold"><i class="armfa armfa-bold"></i></label>
                                ...
                                <label class="arm_font_style_label '.$arm_setup_title_font_italic_class.'" data-value="italic" data-field="arm_setup_title_font_italic"><i class="armfa armfa-italic"></i></label>
                                ...
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_title_font_underline_class.'" data-value="underline" data-field="arm_setup_title_font_decoration"><i class="armfa armfa-underline"></i></label>
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_title_font_line_through_class.'" data-value="line-through" data-field="arm_setup_title_font_decoration"><i class="armfa armfa-strikethrough"></i></label>
                    ...
                    $arm_setup_additional_form_fields .= '<div class="arm_setup_option_field">
                        ...
                        <div class="arm_setup_option_input">
                            ...
                            <div class="arm_font_style_options">
                                ...
                                <label class="arm_font_style_label '.$arm_setup_description_font_bold.'" data-value="bold" data-field="arm_setup_description_font_bold"><i class="armfa armfa-bold"></i></label>
                                ...
                                <label class="arm_font_style_label '.$arm_setup_description_font_italic.'" data-value="italic" data-field="arm_setup_description_font_italic"><i class="armfa armfa-italic"></i></label>
                                ...
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_description_font_underline.'" data-value="underline" data-field="arm_setup_description_font_decoration"><i class="armfa armfa-underline"></i></label>
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_description_font_line_through.'" data-value="line-through" data-field="arm_setup_description_font_decoration"><i class="armfa armfa-strikethrough"></i></label>
                    ...
                    $arm_setup_additional_form_fields .= '<div class="arm_setup_option_field">
                        ...
                        <div class="arm_setup_option_input">
                            ...
                            <div class="arm_font_style_options">
                                ...
                                <label class="arm_font_style_label '.$arm_setup_price_font_bold.' data-value="bold" data-field="arm_setup_price_font_bold"><i class="armfa armfa-bold"></i></label>
                                ...
                                <!--/. Font Italic Option ./-->
                                <label class="arm_font_style_label '.$arm_setup_price_font_italic.'" data-value="italic" data-field="arm_setup_price_font_italic"><i class="armfa armfa-italic"></i></label>
                                ...
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_plan_font_underline.'" data-value="underline" data-field="arm_setup_price_font_decoration"><i class="armfa armfa-underline"></i></label>
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_plan_font_line_through.'" data-value="line-through" data-field="arm_setup_price_font_decoration"><i class="armfa armfa-strikethrough"></i></label>
                    ...
                    $arm_setup_additional_form_fields .= '<div class="arm_setup_option_field">
                        ...
                        <div class="arm_setup_option_input">
                            ...
                            <div class="arm_font_style_options">
                                <!--/. Font Bold Option ./-->
                                <label class="arm_font_style_label '.$arm_setup_summary_font_bold.'" data-value="bold" data-field="arm_setup_summary_font_bold"><i class="armfa armfa-bold"></i></label>
                                ...
                                <!--/. Font Italic Option ./-->
                                <label class="arm_font_style_label '.$arm_setup_summary_font_italic.'" data-value="italic" data-field="arm_setup_summary_font_italic"><i class="armfa armfa-italic"></i></label>
                                ...
                                <!--/. Text Decoration Options ./-->
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_summary_font_underline.'" data-value="underline" data-field="arm_setup_summary_font_decoration"><i class="armfa armfa-underline"></i></label>
                                <label class="arm_font_style_label arm_decoration_label '.$arm_setup_summary_font_line_through.'" data-value="line-through" data-field="arm_setup_summary_font_decoration"><i class="armfa armfa-strikethrough"></i></label>
            ...
            $arm_setup_additional_form_fields .= '<div class="arm_setup_option_field">
                <div class="arm_setup_option_label">'. esc_html__('Color Options', 'ARMember').'</div>
                <div class="arm_setup_option_input">
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Plan Title Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Plan Description Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Price Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                    ...
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Selected Plan Title Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Selected Plan Description Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Selected Price Font', 'ARMember').'</span>
                    </div>
                    <div class="arm_setup_color_options">
                        ...
                        <span>'. esc_html__('Selected Plan Background', 'ARMember').'</span>
                    </div>
                </div>
            </div>
            ...
            <div class="arm_setup_option_field">
                ...
                <div class="arm_setup_option_input">
                    ...
                    <span class="arm_section_custom_css_section">
                        <a class="arm_custom_css_detail arm_custom_css_detail_link" href="javascript:void(0)" data-section="arm_membership_setup">'. esc_html__('CSS Class Information', 'ARMember').'</a>
                    </span>
                </div>
            </div>';
        ...
        function arm_plan_cycle_skin_types_func($arm_plan_cycle_skin, $setup_data,$setup_modules,$arm_class){
            ...
            $arm_plan_cycle_skin = '<div class="arm_setup_option_field">
                <div class="arm_setup_option_label arm_padding_top_10">'. esc_html__('Select Payment Cycle Layout', 'ARMember').'</div>
                <div class="arm_setup_option_input">
                    <div class="arm_column_layout_types_container '. esc_attr($arm_class).'">
                        <label class="'.$arm_cycle_column_1_class.'">
                            <img class="arm_inactive_img" src="'. MEMBERSHIP_IMAGES_URL.'/single_column.png" alt=""/>
                            <img class="arm_active_img" src="'. MEMBERSHIP_IMAGES_URL.'/single_column_hover.png" alt=""/>
                        ...
                        <label class="'.$arm_cycle_column_2_class.'">
                            <img class="arm_inactive_img" src="'. MEMBERSHIP_IMAGES_URL.'/two_column.png" alt=""/>
                            <img class="arm_active_img" src="'. MEMBERSHIP_IMAGES_URL.'/two_column_hover.png" alt=""/>
                        ...
                        <label class="'.$arm_cycle_column_3_class.'">
                            <img class="arm_inactive_img" src="'. MEMBERSHIP_IMAGES_URL.'/three_column.png" alt=""/>
                            <img class="arm_active_img" src="'. MEMBERSHIP_IMAGES_URL.'/three_column_hover.png" alt=""/>
                        ...
                        <label class="'.$arm_cycle_column_4_class.'">
                            <img class="arm_inactive_img" src="'. MEMBERSHIP_IMAGES_URL.'/four_column.png" alt=""/>
                            <img class="arm_active_img" src="'. MEMBERSHIP_IMAGES_URL.'/four_column_hover.png" alt=""/>
        ...
        function arm_other_option_payment_gateway_skins_func($arm_other_option_payment_skins,$setup_data,$setup_modules){
            ...
            $arm_other_option_payment_skins ='<div class="arm_setup_option_field">
        ...
        function arm_setup_summary_content_shortcode_func($arm_summary_shortcode)
        {
            ...
            $arm_summary_shortcode = '<li><code>[PLAN_NAME]</code> - '. esc_html__("This will be replaced with selected plan's title.", 'ARMember').'</li>
            <li><code>[PLAN_CYCLE_NAME]</code> - '. esc_html__("This will be replaced with selected payment cycles's title of the selected subscription plan.", 'ARMember').'</li>
            <li><code>[PLAN_AMOUNT]</code> - '. esc_html__("This will be replaced with selected plan's amount.", 'ARMember').'</li>
            <li><code>[DISCOUNT_AMOUNT]</code> - '. esc_html__("This will be replaced with applied coupon's amount.", 'ARMember').'</li>
            <li><code>[PAYABLE_AMOUNT]</code> - '. esc_html__("This will be replaced with final payable amount.", 'ARMember').'</li>
            <li><code>[TRIAL_AMOUNT]</code> - '. esc_html__("This will be replaced with plan's trial period amount.", 'ARMember').'</li>';
            if($enable_tax == 1){
                $arm_summary_shortcode .= '<li><code>[TAX_PERCENTAGE]</code> - '. esc_html__("This will be replaced with tax percentage.", 'ARMember').'</li>
                <li><code>[TAX_AMOUNT]</code> - '. esc_html__("This will be replaced with tax amount.", 'ARMember').'</li>';
                if($arm_pro_ration_feature->isProRationFeature) {
                    $arm_summary_shortcode .= '<li><code>[PRO_RATA_AMOUNT]</code> - '. esc_html__("This will be replaced with applied Pro-Rata amount.", 'ARMember').'</li>';
                }
        ...
        function arm_styling_plan_skin_section_func($arm_styling_plan_skin_section, $setup_data,$setup_modules){
            ...
            <div class="arm_setup_option_field">
                <div class="arm_setup_option_label">'. esc_html__('Two Step Sign-up', 'ARMember').'</div>
                <div class="arm_setup_option_input">
            ...
            $arm_styling_plan_skin_section .= '<div class="arm_setup_option_field enable_two_steps" '.$arm_styling_two_step_section_css.'>
                ...
                <div class="arm_setup_option_input">
                    <div class="arm_setup_module_box">
                        <input type="text" name="setup_data[setup_labels][button_labels][next]" value="'.$arm_two_step_next_lbl.'">
            ...
            <div class="arm_setup_option_field enable_two_steps"  '.$arm_styling_two_step_section_css.'>
                ...
                <div class="arm_setup_option_input">
                    <div class="arm_setup_module_box">
                        <input type="text" name="setup_data[setup_labels][button_labels][previous]" value="'.$arm_two_step_prev_lbl.'">
                        <span class="arm_setup_error_msg"></span>
                    </div>
                </div>
            </div>';
            ...
            $arm_pro_other_form_setup_form = '<div class="arm_setup_option_field">
                ...
                <div class="arm_setup_option_input">
                    <div class="arm_opt_content_wrapper arm_card_icon_container">
                        <div class="arm_card_icon_wrapper '.$credit_card_section_hidden.'">
                            <span>'. esc_html__('Upload', 'ARMember').'</span>
                            <input type="file" class="arm_card_icon" id="arm_card_icon_input" data-arm_clicked="not" data-avatar-type="credit_card_logos" data-arm_card_icon="arm_card_icon" />
                        </div>
                        ...
                        <input type="hidden" class="arm_card_icon_file_url" name="setup_data[setup_labels][credit_card_logos]" value="'.$arm_credit_card_logos.'" />
                        <div class="arm_remove_default_cover_photo_wrapper arm_card_icon_remove '.$arm_view_credit_card.'">
                            <span>'. esc_html__('Remove','ARMember').'</span>  
                        </div>
                        <div class="arm_card_icon_selected_img '.$arm_credit_card_logos_cls.'"><img src="'.$arm_credit_card_logos.'" class="'.$arm_credit_card_logos_cls.'" /></div>
                    </div>
                </div>
            </div>';
        ...
        function arm_pro_additional_fields_for_other_options_func($arm_pro_additional_fields_for_other_options,$setup_data,$setup_modules,$button_labels){
            ...
            $arm_pro_additional_fields_for_other_options = '<div class="arm_setup_option_field arm_setup_coupon_labels '.$is_arm_coupon_option_enabled.'">
            ...
            <div class="arm_setup_option_field arm_setup_coupon_labels '.$is_arm_coupon_option_enabled.'">
        ...
        function arm_setup_additional_basic_option_section_func($arm_setup_additional_basic_options,$setup_modules){
            ...
            if ($arm_manage_coupons->isCouponFeature){
                ...
                $arm_setup_additional_basic_options .= '<div class="arm_setup_option_field">
                    <div class="arm_setup_option_label arm_padding_top_10">'. esc_html__('Enable coupon with payment','ARMember').'</div>
                    <div class="arm_setup_option_input arm_coupon_enable_radios">
                        ...
                        <label for="arm_setup_coupon_chk_yes">'. esc_html__('Yes', 'ARMember').'</label>
                        ...
                        <label for="arm_setup_coupon_chk_no">'. esc_html__('No', 'ARMember').'</label>
                    </div>
                </div>
                                        
                <div class="arm_setup_option_field " id="arm_coupon_invitation_code" '.$is_coupon_option_module_enabled_cls.'>
        ...
        function arm_pro_add_new_register_form_btn_field_func($arm_add_new_form_btn){
            global $arm_slugs;
            $arm_add_new_form_btn = '<a href="'. esc_url(admin_url('admin.php?page='.$arm_slugs->manage_forms.'&setup=true')).'" target="_blank" class="arm_setup_conf_links arm_ref_info_links">'. esc_html__('Add New Form', 'ARMember').'</a>';
        ...
        function arm_pro_setup_form_style_section_func($arm_pro_setup_style_section,$setup_data,$arm_setup_type){
            ...
            if($arm_pay_per_post_feature->isPayPerPostFeature){
                ...
                $arm_pro_setup_style_section .='<div class="arm_setup_option_field">
                ...
                if($arm_membership_setup_type_content != ""){
                    $arm_pro_setup_style_section .='<div class="arm_setup_option_field">
                        ...
                        <div class="arm_setup_option_input arm_setup_type_enable_radios">
                            ...
                            <label for="arm_setup_type_plan_setup">'.esc_html_e('Membership Plan Setup', 'ARMember').'</label>'.
                            $arm_membership_setup_type_content.'
                        </div>
                    </div>'; 
                } else {
        ...
        function arm_setup_shortcode_func($atts, $content = "") {
            global $wp, $wpdb, $current_user, $ARMember, $arm_member_forms, $arm_global_settings, $arm_payment_gateways, $arm_manage_coupons, $arm_subscription_plans, $bpopup_loaded, $ARMSPAMFILEURL, $arm_pro_ration_feature;
            $ARMember->arm_session_start();
            /* ====================/.Begin Set Shortcode Attributes./==================== */
            $defaults = array(
                'id' => 0, /* Membership Setup Wizard ID */
        ...
        function arm_setup_plan_list_options($selectedPlans = array(), $allPlans = array()) {
            ...
            if (!empty($allPlans)) {
                foreach ($allPlans as $plan) {
                    ...
                    $planList .= '<input type="checkbox" name="setup_data[setup_modules][modules][plans][]" value="' . esc_attr($plan_id) . '" id="plan_chk_' . esc_attr($plan_id) . '" class="arm_icheckbox plans_chk_inputs plans_chk_inputs_' . esc_attr($planObj->type) . '" ' . $planInputAttr . ' data-msg-required="' . esc_attr__('Please select atleast one plan.', 'ARMember') . '"/>';
        ...
        function arm_setup_gateway_list_options($selectedGateways = array(), $activeGateways = array(), $selectedPaymentModes = array(), $selectedPlans = array(), $plan_object_array = array()) {
            ...
            if (!empty($activeGateways)) {
                ...
                foreach ($activeGateways as $key => $pg) {
                    ...
                    $gatewayList .= '<input type="checkbox" name="setup_data[setup_modules][modules][gateways][]" value="' . esc_attr($key) . '" id="gateway_chk_' . esc_attr($key) . '" class="arm_icheckbox gateways_chk_inputs" data-pg_name="' . esc_attr($pg['gateway_name']) . '" ' . $gatewayChecked . ' data-msg-required="' . esc_attr__('Please select atleast one payment gateway.', 'ARMember') . '"/>';
                    ...
                    if (!in_array($key, $doNotDisplayPaymentMode)) {
                        ...
                        $gatewayList .= '<div class="arm_gateway_payment_mode_box" style="' . $arm_display_payment_mode_box . '"><div class="' . esc_attr($key) . '_gateway_payment_mode_class" id="arm_gateway_payment_mode_box" style="' . $display_payment_mode . '">
                           <label>' . esc_html__('In case of subscription plan selected', 'ARMember') . '</label>
                               <br/>
                                        ...
                                        <label for="arm_' . esc_attr($key) . '_auto_mode">' . esc_html__('Allow Auto debit method only', 'ARMember') . '</label><br>
                                        ...
                                        <label for="arm_' . esc_attr($key) . '_manual_mode">' . esc_html__('Allow Semi Automatic(manual) method only', 'ARMember') . '</label><br>
                                        ...
                                        <label for="arm_' . esc_attr($key) . '_both_mode">' . esc_html__('Both (allow user to select payment method)', 'ARMember') . '</label><br>' . $gateway_note . '
                                    </div></div>';
                    }
                    if (in_array($key, $doNotDisplayPaymentMode)) {
            ...
            if (isset($posted_data) && !empty($posted_data) && in_array($posted_data['form_action'], array('add', 'update'))) {
                ...
                if (!empty($setup_data)) {
                    ...
                    if ($posted_data['form_action'] == 'add') {
                        ...
                        $ARMember->arm_set_message('success', esc_html__('Membership setup wizard has been added successfully.', 'ARMember'));
