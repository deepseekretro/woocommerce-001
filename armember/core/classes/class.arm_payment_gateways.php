...
if (!class_exists('ARM_payment_gateways')) {
    ...
    class ARM_payment_gateways {
        ...
        function armember_pro_gateways_fields_section_func($arm_gateway_fields,$gateway_name,$gateway_options){
            ...
            switch($gateway_name){
                case 'stripe':
                    ...
                    $arm_gateway_fields = '<tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Payment Mode', 'ARMember').'</label></th>
                        <td class="arm-form-table-content">
                            <div id="arm_stripe_mode_container" class="arm_stripe_mode_container">
                                <input id="arm_stripe_mode_test" class="arm_general_input arm_stripe_mode_radio arm_iradio arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" type="radio" value="test" name="payment_gateway_settings[stripe][stripe_payment_mode]" '. $is_test_mode_checked.' '.  $disabled_field_attr.'>
                                <label for="arm_stripe_mode_test">'. esc_html__('Test', 'ARMember').'</label>
                                <input id="arm_stripe_mode_live" class="arm_general_input arm_stripe_mode_radio arm_iradio arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" type="radio" value="live" name="payment_gateway_settings[stripe][stripe_payment_mode]" '. $is_live_mode_checked.' '.  $disabled_field_attr.'>
                                <label for="arm_stripe_mode_live">'. esc_html__('Live', 'ARMember').'</label>
                            </div>
                        </td>
                    </tr>';
                    ...
                    $arm_gateway_fields .= '<tr class="form-field arm_pay_gate_stripe_live_mode '. $stripe_live_hidden_section.'">
                        <th class="arm-form-table-label"><label><label>'. esc_html__('Live Secret Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_stripe_live_secrate_key" type="text" name="payment_gateway_settings[stripe][stripe_secret_key]" value="'.$stripe_live_secret_key.'" data-msg-required="'. esc_html__('Live Secret Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr .'>
                        </td>
                    </tr>
                    <tr class="form-field arm_pay_gate_stripe_live_mode '.$stripe_live_hidden_section.'">
                        <th class="arm-form-table-label"><label><label>'. esc_html__('Live Publishable Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_stripe_live_pub_key" type="text" name="payment_gateway_settings[stripe][stripe_pub_key]" value="'.$stripe_live_pub_key.'" data-msg-required="'. esc_html__('Live Publishable Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>';
                    ...
                    $arm_gateway_fields .= '<tr class="form-field arm_pay_gate_stripe_test_mode '.$stripe_test_hidden_section.'">
                        <th class="arm-form-table-label"><label><label>'. esc_html__('Test Secret Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_stripe_test_secrate_key" type="text" name="payment_gateway_settings[stripe][stripe_test_secret_key]" value="'.$stripe_test_secret_key.'" data-msg-required="'. esc_html__('Test Secret Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field arm_pay_gate_stripe_test_mode '.$stripe_test_hidden_section.'">
                        <th class="arm-form-table-label"><label><label>'. esc_html__('Test Publishable Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_stripe_test_pub_key" type="text" name="payment_gateway_settings[stripe][stripe_test_pub_key]" value="'.$stripe_test_pub_key.'" data-msg-required="'. esc_html__('Test Publishable Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>';
                    ...
                    <tr class="form-field">
                        ...
                        <td class="arm-form-table-content">
                            ...
                            <div class="arm_stripe_payment_method_container" id="arm_stripe_payment_method_container">
                                <input id="arm_stripe_payment_method_fields" class="arm_general_input arm_stripe_payment_method_radio arm_iradio arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" type="radio" value="fields" name="payment_gateway_settings[stripe][stripe_payment_method]" '. $is_stripe_field_checked.' '. $disabled_field_attr.' />
                                <label for="arm_stripe_payment_method_fields">'. esc_html__('Built-In Form Fields','ARMember').'</label>
                                <input id="arm_stripe_payment_method_popup" class="arm_general_input arm_stripe_payment_method_radio arm_iradio arm_active_payment_'. strtolower(esc_attr($gateway_name)) .'" type="radio" value="popup" name="payment_gateway_settings[stripe][stripe_payment_method]" '. $is_stripe_sca_checked .' '. $disabled_field_attr.' />
                                <label for="arm_stripe_payment_method_popup">'. esc_html__('SCA Compliant (popup)','ARMember').'</label>
                            </div>
                        </td>
                    </tr>';
                    ...
                    $arm_gateway_fields .= '<tr class="form-field arm_stripe_payment_method_popup_fields '.$arm_stripe_popup_section.'">
                        <th class="arm-form-table-label"><label>'. esc_html__('Popup Title', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_stripe_popup_title_lbl" type="text" name="payment_gateway_settings[stripe][stripe_popup_title]" value="'.$arm_stripe_popup_title.'" data-msg-required="'. esc_html__('Popup Title can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                    ...
                    <tr class="form-field arm_stripe_payment_method_popup_fields '.$arm_stripe_popup_section.'">
                        <th class="arm-form-table-label"><label>'. esc_html__('Payment Button Label', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_stripe_popup_button_lbl" type="text" name="payment_gateway_settings[stripe][stripe_popup_button_lbl]" value="'.$arm_stripe_popup_button_lbl.'" data-msg-required="'. esc_html__('Payment Button Label can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field arm_stripe_payment_method_popup_fields '.$arm_stripe_popup_section.'">
                        <th class="arm-form-table-label"><label>'. esc_html__('Popup Logo', 'ARMember').'</label></th>
                        <td class="arm-form-table-content">
                            <div class="arm_opt_content_wrapper arm_stripe_popup_icon_container">
                                <div class="arm_stripe_popup_icon_wrapper '.$arm_stripe_popup_icon_hidden.'">
                                    <span>'. esc_html__('Upload', 'ARMember').'</span>
                                ...
                                <div class="arm_remove_default_cover_photo_wrapper arm_stripe_popup_icon_remove '.$arm_stripe_popup_icon_hidden_show.'">
                                    <span>'. esc_html__('Remove','ARMember').'</span>
                                </div>
                                <div class="arm_stripe_popup_icon_selected_img '.$arm_stripe_popup_icon_hidden_show.'"><img src="'.$arm_stripe_popup_icon.'" class="'.$arm_stripe_popup_icon_hidden_show.'" /></div>
                                <div class="arm_font_size_12 arm_margin_top_5" >('. esc_html__('Recommended logo size 70X70 px','ARMember').')</div>
                            </div>
                        </td>
                    </tr>';
                    ...
                    <tr class="form-field arm_stripe_payment_method_popup_fields '.$arm_stripe_popup_section.'">
                        <th class="arm-form-table-label"><label>'. esc_html__('Expiration Label', 'ARMember').'</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_payment_gateway_'. esc_attr($gateway_name).'_em_label" type="text" name="payment_gateway_settings['. esc_attr($gateway_name).'][sca_em_label]" value="'.$arm_sca_em_label.'" '. $readonly_field_attr.'>
                            <i class="arm_helptip_icon armfa armfa-question-circle" title="'. esc_html__("This label will be displayed at frontend membership setup wizard page while payment.", 'ARMember').'"></i>
                        </td>
                    </tr>
                    <tr class="form-field arm_stripe_payment_method_popup_fields '.$arm_stripe_popup_section.'">
                        <th class="arm-form-table-label"><label>'. esc_html__('CVV Label', 'ARMember').'</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_payment_gateway_'. esc_attr($gateway_name).'_cvv_label" type="text" name="payment_gateway_settings['. esc_attr($gateway_name).'][sca_cvv_label]" value="'.$arm_sca_cvv_label.'" '. $readonly_field_attr.'>
                            <i class="arm_helptip_icon armfa armfa-question-circle" title="'. esc_html__("This label will be displayed at frontend membership setup wizard page while payment.", 'ARMember').'"></i>
                        </td>
                    </tr>';
                    ...
                    $arm_gateway_fields .= '<tr class="form-field">
                        ...
                        <td class="arm-form-table-content">
                            <div class="arm_authorize_net_mode_container" id="arm_authorize_net_mode_container">
                                <input id="arm_autho_mode_sand" class="arm_general_input arm_iradio arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" type="radio" value="sandbox" name="payment_gateway_settings[authorize_net][autho_mode]" '. $is_test_mode_checked.' '. $disabled_field_attr.'>
                                <label for="arm_autho_mode_sand">'. esc_html__('Sandbox', 'ARMember').'</label>
                                <input id="arm_autho_mode_live" class="arm_general_input arm_iradio arm_active_payment_'. strtolower(esc_attr($gateway_name) ).'" type="radio" value="live" name="payment_gateway_settings[authorize_net][autho_mode]" '. $is_live_mode_checked.' '. $disabled_field_attr.'>
                                <label for="arm_autho_mode_live">'. esc_html__('Live', 'ARMember').'</label>
                            </div>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('API Login ID', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_autho_api_key" type="text" name="payment_gateway_settings[authorize_net][autho_api_login_id]" value="'.$arm_autho_api_login_id.'" data-msg-required="'. esc_html__('API Login ID can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Transaction Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_autho_transaction_key" type="text" name="payment_gateway_settings[authorize_net][autho_transaction_key]" value="'.$arm_autho_transaction_key.'" data-msg-required="'. esc_html__('Transaction Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>';
                    ...
                    $arm_gateway_fields .= '<tr class="form-field">
                        ...
                        <td class="arm-form-table-content">
                            <div class="arm_2checkout_mode_container" id="arm_2checkout_mode_container">
                                <input class="arm_general_input arm_2checkout_mode_radio arm_iradio arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" type="radio" value="sandbox" id="arm_2checkout_mode_sandbox" name="payment_gateway_settings[2checkout][payment_mode]" '. $is_test_mode_checked.' '. $disabled_field_attr.'>
                                <label for="arm_2checkout_mode_sandbox">'. esc_html__('Sandbox', 'ARMember').'</label>
                                <input class="arm_general_input arm_2checkout_mode_radio arm_iradio arm_active_payment_'. strtolower(esc_attr($gateway_name) ).'" type="radio" value="live" id="arm_2checkout_mode_live" name="payment_gateway_settings[2checkout][payment_mode]" '. $is_live_mode_checked.' '. $disabled_field_attr.'>
                                <label for="arm_2checkout_mode_live">'. esc_html__('Live', 'ARMember').'</label>
                            </div>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('API Username', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_2checkout_username" type="text" name="payment_gateway_settings[2checkout][username]" value="'.$arm_checkout_username.'" data-msg-required="'. esc_html__('API Username can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('API Password', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_2checkout_password" type="text" name="payment_gateway_settings[2checkout][password]" value="'.$arm_checkout_password.'" data-msg-required="'. esc_html__('API Password can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Seller Id (account number)', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_2checkout_sellerid" type="text" name="payment_gateway_settings[2checkout][sellerid]" value="'.$arm_checkout_seller_id.'" data-msg-required="'. esc_html__('SellerId can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Private Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower(esc_attr($gateway_name)).'" id="arm_2checkout_private_key" type="text" name="payment_gateway_settings[2checkout][private_key]" value="'.$arm_checkout_private_key.'" data-msg-required="'. esc_html__('Private Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('API Secret Key', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_2checkout_api_secret_key" type="text" name="payment_gateway_settings[2checkout][api_secret_key]" value="'.$arm_checkout_api_secret_key.'" data-msg-required="'. esc_html__('API Secret Key can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Secret Word', 'ARMember').' *</label></th>
                        <td class="arm-form-table-content">
                            <input class="arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" id="arm_2checkout_secret_word" type="text" name="payment_gateway_settings[2checkout][secret_word]" value="'.$arm_checkout_secret_word.'" data-msg-required="'. esc_html__('Secret Word can not be left blank.', 'ARMember').'" '. $readonly_field_attr.'>
                        </td>
                    </tr>
                    <tr class="form-field">
                        <th class="arm-form-table-label"><label>'. esc_html__('Language', 'ARMember').'</label></th>
                        <td class="arm-form-table-content">';
                            ...
                            <dl class="arm_selectbox arm_active_payment_'. strtolower( esc_attr($gateway_name) ).'" '. $disabled_field_attr.'>
        ...
        function arm_gateway_callback_info_func($apiCallbackUrlInfo, $gateway_name, $gateway_options){
            ...
            switch ($gateway_name) {
                ...
                case '2checkout':
                    ...
                    $apiCallbackUrlInfo .=  '<br/><br/>'.esc_html__('In case of Recurring Billing, Please make sure you have set following URL in the Global URL field in your 2Checkout account.', 'ARMember');
        ...
        function arm_change_payment_gateway_tooltip_func($titleTooltip, $gateway_name, $gateway_options)
        {
            ...
            switch ($gateway_name) {
                case 'stripe':
                    ...
                    break;
                case 'authorize_net':
                    $titleTooltip = esc_html__('You can find your Login ID & Transaction Key from your authorize.net account. To get more details, Please refer this', 'ARMember').' <a href="https://support.authorize.net/authkb/index?page=content&id=A576" target="_blank">'.esc_html__('document', 'ARMember').'.</a>';
        ...
        function arm_download_general_debug_log(){
            ...
            echo admin_url( 'admin.php?page=arm_general_settings&action=debug_logs&arm_action=download_log&file=' . $debug_log_file_name . '&arm_wp_nonce=' . $arm_wp_nonce ); //phpcs:ignore
            exit();
        }
                ...
                switch ($key) {
                    ...
                    case 'card_number':
                        ...
                        $card_imgs ='<div class="arm_module_gateway_card_images">
                            <img src="'.esc_url($arm_card_image_url).'"/>
                        </div>';
                        break;
                    case 'cvc':
