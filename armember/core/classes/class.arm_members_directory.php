...
if (!class_exists('ARM_members_directory')) {
    ...
    class ARM_members_directory {
        ...
        function arm_add_new_profile_view_content_box_func($arm_add_new_profile_view_content_box,$type){
            $arm_add_new_profile_view_content_box = '<div id="arm_add_template_profile" class="arm_add_template_box arm_add_template_'.$type.'" data-type="'.$type.'">
                <div class="arm_add_template_box_content">
                    <img src="'. MEMBERSHIP_IMAGES_URL.'/pd-add-circle-icon.png" alt="add-icon">
            ...
            $arm_confirm_box_profile_delete .='<div class="arm_confirm_box arm_confirm_box_'. esc_attr($t_id).'" id="arm_confirm_box_'. esc_attr($t_id).'">
                <div class="arm_confirm_box_body">
                    ...
                    <div class="arm_confirm_box_btn_container">
                        <button type="button" class="arm_confirm_box_btn armok arm_template_delete_btn" data-item_id="'. esc_attr($t_id).'" data-type="">'. esc_html__('Delete', 'ARMember').'</button>
        ...
        function arm_profile_template_btn_content_func($arm_edi_del_section_profile,$t_id,$ptemp,$t_link_attr,$type){
            ...
            $arm_edi_del_section_profile = '<a href="'.$arm_profile_url.'" class="arm_template_copy_link armhelptip" title="'. esc_html__('Copy Template', 'ARMember').'" '. esc_html($t_link_attr).'><img src="'. MEMBERSHIP_IMAGES_URL.'/dir_copy_icon.png" alt="" /></a>';
            if ($ptemp['arm_default'] != 1) {
                $arm_edi_del_section_profile .= '<a href="javascript:void(0)" class="arm_template_delete_link armhelptip" title="'. esc_html__('Delete Template', 'ARMember').'" '. esc_html($t_link_attr).' onclick="showConfirmBoxCallback(\''. esc_attr($t_id).'\');"><img src="'. MEMBERSHIP_IMAGES_URL.'/dir_delete_icon.png" alt="" /></a>';
            }
        ...
        function arm_profile_editor_css_section_func($arm_profile_editor_css_section,$options){
            ...
            $arm_profile_editor_css_section = '<div class="arm_custom_css_popup_wrapper">
                <div class="arm_custom_css_popup_inner_wrapper">
                    <div class="popup_header">
                        '. esc_html__('Custom CSS', 'ARMember').'
                    ...
                    <div class="popup_content_btn popup_footer">
                        <button type="button" class="arm_custom_css_popup_footer_button armemailaddbtn" id="arm_custom_css_apply_button" style="padding-bottom: 10px;">'. esc_html__('Apply','ARMember').'</button>
                    </div>
                </div>
        ...
        function arm_profile_directories_additional_popup_action_func($arm_additional_form_belt_actions,$profile_templates,$temp_slug){
            ...
            $arm_additional_form_belt_actions ='<div id="arm_profile_settings_popup" class="arm_profile_belt_right_icon"  title="'. esc_html__('Change Profile Template', 'ARMember').'">
                ...
                <div class="arm_profile_settings_popup" id="arm_profile_settings_popup_div" style="display:none;">
                    ...
                    <input type="hidden" name="arm_profile_template" value="'. esc_attr($temp_slug).'" id="arm_profile_template" />
                    ...
                    <div class="arm_profile_template_settings_popup_footer">
                        <button type="button" class="armemailaddbtn" id="arm_profile_template_settings_close">'. esc_html__('Apply','ARMember').'</button>
                    </div>
                </div>
            </div>';
        ...
        function arm_save_profile_template_func( $nonce_flag = 1) {
            ...
            $arm_slug = isset($_POST['arm_profile_template']) ? sanitize_text_field( $posted_data['arm_profile_template'] ) : 'profiletemplate1';//phpcs:ignore
            $arm_type = "profile";
            ...
            if( $profile_action == 'add_profile' || $profile_action == 'duplicate_profile' ){
                if( $wpdb->insert($ARMember->tbl_arm_member_templates,$arguments) ){
                    echo json_encode(array('type' => 'success','id' => $wpdb->insert_id, 'message' => esc_html__('Template Saved Successfully','ARMember'), 'default_data' => $default_data));
                } else {
                    echo json_encode(array('type' => 'error', 'message' => esc_html__('There is an error while saving template, please try again','ARMember')));
                }
                ...
                if( $id > 0 && $wpdb->update($ARMember->tbl_arm_member_templates,$arguments,array('arm_id' => $id) ) ){
                    ...
                    {
                        echo json_encode(array('type' => 'success','id' => $id, 'message' => esc_html__('Template Updated Successfully','ARMember'), 'default_data' => $default_data));
                    }
                } else {
                    if($arm_new_profile_update != 'yes')
                    {
                        echo json_encode(array('type' => 'error', 'message' => esc_html__('There is an error while updating template, please try again','ARMember')));    
                    }
                }
            } else {
                echo json_encode(array('type' => 'error', 'message' => esc_html__('There is an error while saving template, please try again','ARMember')));
            ...
            if (isset($posted_data['action']) && $posted_data['action'] == 'arm_add_template') {
             $templateType = isset($posted_data['temp_type']) ? $posted_data['temp_type'] : '';
                ...
                if($templateType == "profile"){
                    $arm_template_title = !empty($posted_data['arm_profile_template_name']) ? $posted_data['arm_profile_template_name'] : '';
                } else if($templateType == "directory"){
                    $arm_template_title = !empty($posted_data['arm_directory_template_name']) ? $posted_data['arm_directory_template_name'] : '';
                }
                    ...
                    if (!empty($profileCover) && file_exists(MEMBERSHIP_UPLOAD_DIR . '/' . basename($profileCover))) {
                        ...
                        if ( !empty($args['template_options']['default_cover_photo']) )
                        {
                            if (isset($args['template_options']['default_cover']) && !empty($args['template_options']['default_cover'])) {
                                ...
                                $users[$user->ID]['profile_cover'] = MEMBERSHIP_IMAGES_URL.'/profile_default_cover.png';
                            }
                        }
                    }
                        ...
                        if (!empty($user_achievements_detail)) {
                            ...
                            if( file_exists(MEMBERSHIP_UPLOAD_DIR.'/social_badges/'.$arm_badges_icon_end) ){
                               ...
                               $user_achieve['badge_icon'] = $user_achieve['badge_icon'];
                                ...
                                $userBadges .= '<span class="arm-user-badge armhelptip_front" title="'.esc_attr($user_achieve['badge_title']).'"><img alt="" src="'.esc_attr($user_achieve['badge_icon']).'" style="'.$badge_css.'" /></span>';                               
                            }
                        }
                ...
                if (!empty($_data)) {
                    ...
                    if (isset($opts['template_options']['pagination']) && $opts['template_options']['pagination'] == 'infinite') {
                        if ($total_users > ($current_page * $per_page)) {
                            ...
                            $paging .= '<img class="arm_load_more_loader" src="'.MEMBERSHIP_IMAGES_URL.'/arm_loader.gif" alt="' . esc_html__('Load More', 'ARMember') . '" style="display:none;">';
                        ...
                        $popup .= '<form action="#" method="post" onsubmit="return false;" class="arm_template_edit_form arm_admin_form" id="arm_template_edit_form" data-temp_id="'.$temp_id.'">';
                            ...
                            $popup .= '<tr class="popup_wrapper_inner">';
                                $popup .= '<td class="popup_header">';
                                    ...
                                    $popup .= '<span>' . esc_html__('Edit Template Options', 'ARMember') . '</span>';
                                $popup .= '</td>';
                                ...
                                $popup .= '<td class="popup_content_btn popup_footer">';
                                    ...
                                    $popup .= '<a href="javascript:void(0)" class="arm_section_custom_css_detail_hide_template armemailaddbtn"><img src="' . $backToListingIcon . '"/>' . esc_html__('Back to template options', 'ARMember') . '</a>';
                                    $popup .= '</div>';
                                $popup .= '</td>';
                            $popup .= '</tr>';
                            $popup .= '</table>';
            ...
            $tempOptHtml .= '<div class="arm_temp_option_wrapper">';
                $tempOptHtml .= '<table class="arm_table_label_on_top">';
                    ...
                    if ($tempType == 'profile')
                    {
                        ...
                        $tempOptHtml .= '</div>';
                        $tempOptHtml .= '<label for="arm_template_show_admin_users" class="arm_temp_form_label">' . esc_html__('Display Administrator Users', 'ARMember') . '</label>';
                        $tempOptHtml .= '</td>';
                    $tempOptHtml .= '</tr>';
                    ...
                    $tempOptHtml .= '<tr>';
                        ...
                        $tempOptHtml .= '</div>';
                        $tempOptHtml .= '<label for="arm_template_show_badges" class="arm_temp_form_label">' . esc_html__('Display Member Badges', 'ARMember') . '</label>';
                        $tempOptHtml .= '</td>';
                    $tempOptHtml .= '</tr>';
                    ...
                    if ($tempType == 'directory')
                    {
                        ...
                        $tempOptHtml .= '<td colspan="2">';
                            ...
                            $tempOptHtml .= '</div>';
                            $tempOptHtml .= '<label for="arm_template_redirect_to_author" class="arm_temp_form_label">' . esc_html__('Redirect To Author Archive Page', 'ARMember') . '</label>';
                            $tempOptHtml .= '<div class="armclear arm_height_1"></div>';
                            $tempOptHtml .= '<span class="arm_info_text arm_width_450">( '.esc_html__("If Author have no any post than user will be redirect to ARMember Profile Page", 'ARMember').' )</span>';
                        $tempOptHtml .= '</td>';
                        $tempOptHtml .= '</tr>';
                        ...
                        $tempOptHtml .= '<td colspan="2">';
                            ...
                            $tempOptHtml .= '</div>';
                            $tempOptHtml .= '<label for="arm_template_hide_empty_directory_fields" class="arm_temp_form_label">' . esc_html__('Hide Empty Fields', 'ARMember') . '</label>';
                        $tempOptHtml .= '</td>';
                        $tempOptHtml .= '</tr>';
                            ...
                            if (is_plugin_active('buddypress/bp-loader.php')) {
                                if($arm_buddypress_feature->isBuddypressFeature){
                                    $tempOptHtml .= '<tr>';
                                            ...
                                            $tempOptHtml .= '</div>';
                                            $tempOptHtml .= '<label for="arm_template_redirect_to_buddypress_profile" class="arm_temp_form_label">' . esc_html__('Redirect to BuddyPress Profile', 'ARMember') . '</label>';
                                            $tempOptHtml .= '</td>';
                                    $tempOptHtml .= '</tr>';  
                                }
                            }
                ...
                $tempOptHtml .= '<span class="arm_info_text">(' . esc_html__("Leave blank to display all plan's members.", 'ARMember') . ')</span>';
                $tempOptHtml .= '</div>';
                $tempOptHtml .= '</td>';
                $tempOptHtml .= '</tr>';
                        ...
                        $tempOptHtml .= '<tr>';
                            ...
                            $tempOptHtml .= '<div class="arm_temp_switch_wrapper">';
                                ...
                                $tempOptHtml .= '<label for="arm_template_searchbox" class="arm_temp_form_label">' . esc_html__('Display Search Box', 'ARMember') . '</label>';
                            $tempOptHtml .= '</div>';
                            $tempOptHtml .= '<div class="arm_temp_switch_wrapper" class="arm_temp_form_label">';
                                ...
                                $tempOptHtml .= '<label for="arm_template_sortbox" class="arm_temp_form_label">' . esc_html__('Display Sorting Options', 'ARMember') . '</label>';
                            $tempOptHtml .= '</div>';
                            $tempOptHtml .= '</td>';
                        $tempOptHtml .= '</tr>';
                        ...
                        if (!empty($arm_ordered_display_member_fields)) {
                            ...
                            foreach ($arm_ordered_display_member_fields as $fieldMetaKey => $fieldOpt) {
                                ...
                                {
                                    $tempOptHtml .= '<label class="arm_display_members_fields_label" for="arm_display_member_field_edit_'.esc_attr($fieldMetaKey).'_status'.esc_attr($temp_unique_id).'"  >'.stripslashes_deep($fieldOpt['label']).'</label>';
                                }
                            ...
                            $tempOptHtml .= '<div class="arm_temp_color_options" id="arm_temp_color_options" style="'.(($tempCS == 'custom') ? '' : 'display:none;').'">';
                                foreach ($colorOptions as $key => $title) {
                                    ...
                                    $tempOptHtml .= '<div class="arm_pdtemp_color_opts">';
                                        $tempOptHtml .= '<span class="arm_temp_form_label">' . esc_html(sanitize_text_field($title)) . '</span>';
        ...
        function arm_template_preview_func() {
            global $wpdb, $ARMember, $arm_capabilities_global, $arm_shortcodes;
        ...
        function arm_get_profile_editor_template($template,$profile_fields_data,$options,$template_id,$ajax = false,$profile_before_content = '',$profile_after_content = '',$data_type='desktop'){
            ...
            if( $template == 'profiletemplate1' ){
                ...
                $template_data .= "<div class='arm_template_loading'><img src='".MEMBERSHIP_IMAGES_URL."/loader.gif' alt='".esc_html__('Loading','ARMember')."..' /></div>";
                ...
                $template_data .= "<div class='arm_template_loading'><img src='".MEMBERSHIP_IMAGES_URL."/loader.gif' alt='".esc_attr__('Loading','ARMember')."..' /></div>";
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'arm_membership_card_template_edit_popup') {//phpcs:ignore
                ...
                if (!empty($temp_id)) {
                    ...
                    if(!empty($template)) {
                        ...
                        $popup .= '<td class="popup_header">';
                        $popup .= '<span class="popup_close_btn arm_popup_close_btn arm_pdtemp_edit_close_btn"></span>';
                        $popup .= '<span>' . esc_html__('Edit Card Options', 'ARMember') . '</span>';
                        $popup .= '</td>';
                        ...
                        $popup .= '<div class="popup_content_btn_wrapper arm_temp_custom_class_btn hidden_section">';
                        $backToListingIcon = MEMBERSHIP_IMAGES_URL.'/back_to_listing_arrow.png';
                        $popup .= '<a href="javascript:void(0)" class="arm_section_custom_css_detail_hide_template armemailaddbtn"><img src="' . esc_attr($backToListingIcon) . '"/>' . esc_html__('Back to template options', 'ARMember') . '</a>';
                        $popup .= '</div>';
                        $popup .= '</td>';
                        $popup .= '</tr>';
                        $popup .= '</table>';
        ...
        function arm_get_membership_card_template_options_wrapper($card_type='add', $card_opts = '') {
            ...
            $arm_html_cnt .= "<label class='arm_opt_title'>".esc_html__('Card Template Name', 'ARMember')."</label>";
            $arm_html_cnt .= "<br>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_title'>".esc_html__('Select Template', 'ARMember')."</div>";
            $arm_html_cnt .= "<div class='arm_opt_content'>";
            ...
            $arm_html_cnt .= "<div class='arm_solid_divider'></div>";
            $arm_html_cnt .= "<div class='arm_template_option_block'>";
            $arm_html_cnt .= "<div class='arm_opt_title'>".esc_html__('Color Scheme', 'ARMember')."</div>";
            $arm_html_cnt .= "<div class='arm_opt_content'>";
            ...
            $arm_html_cnt .= "<label class='arm_opt_label'>".esc_html__('Title Color', 'ARMember')."</label>";
            ...
            $arm_html_cnt .= "</div>";
            $arm_html_cnt .= "<div class='arm_custom_color_opts'>";
            $arm_html_cnt .= "<label class='arm_opt_label'>".esc_html__('Background Color', 'ARMember')."</label>";
            $arm_html_cnt .= "<div class='arm_custom_color_picker'>";
            ...
            $arm_html_cnt .= "<label class='arm_opt_label'>".esc_html__('Label Color', 'ARMember')."</label>";
            $arm_html_cnt .= "<div class='arm_custom_color_picker'>";
            ...
            $arm_html_cnt .= "<div class='arm_solid_divider'></div>";
            $arm_html_cnt .= "<div class='arm_template_option_block'>";
            $arm_html_cnt .= "<div class='arm_opt_title'>".esc_html__('Font Settings', 'ARMember')."</div>";
            $arm_html_cnt .= "<div class='arm_opt_content'>";
            ...
            $arm_html_cnt .= "<div class='arm_solid_divider'></div>";
            $arm_html_cnt .= "<div class='arm_template_option_block'>";
            $arm_html_cnt .= "<div class='arm_opt_title'>".esc_html__('Other Options','ARMember')."</div>";
            $arm_html_cnt .= "<div class='arm_opt_content'>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_label arm_clog_lbl'>".esc_html__('Company Logo','ARMember')."<br/><span class='arm_clogo_opt'>(".esc_html__('Optional','ARMember').")<span></div>";
            ...
            $arm_html_cnt .= "<span>".esc_html__('Upload', 'ARMember')."</span>";
            ...
            $arm_html_cnt .= "<span>".esc_html__('Remove','ARMember')."</span>";
            $arm_html_cnt .= "</div>";

            $arm_html_cnt .= "<div class='arm_card_selecred_img'><img src='".esc_attr($company_logo)."' class='".(empty($company_logo) ? "hidden_section" : "")."' /></div>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_label arm_clog_lbl'>".esc_html__('Card Background','ARMember')."<br/><span class='arm_clogo_opt'>(".esc_html__('Optional','ARMember').")<span></div>";
            $arm_html_cnt .= "<div class='arm_opt_content_wrapper arm_clogo_cnt_wrapper'>";
            ...
            $arm_html_cnt .= "<div class='arm_card_bg_selected_img'><img src='".esc_attr($card_background)."' class='".(empty($card_background) ? "hidden_section" : "")."' /></div>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_content_wrapper'><input type='text' id='arm_membership_card_height_input' name='membership_card_template_options[card_height]' value='".$card_height."' /><i class='arm_helptip_icon armfa armfa-question-circle' title='".sprintf(esc_html__('Enter card height, for example : %s. %sRecommended height : %s.', 'ARMember'), '320px', '<br>', 'auto')."'></i></div>"; //phpcs:ignore
            $arm_html_cnt .= "</div>";
            ...
            if (!empty($arm_ordered_display_member_fields)) {
                ...
                foreach ($arm_ordered_display_member_fields as $fieldMetaKey => $fieldOpt) {
                    ...
                    {
                        $arm_html_cnt .= '<label class="arm_display_members_fields_label" for="arm_display_member_field_edit_'.esc_attr($fieldMetaKey).'_status'.esc_attr($temp_unique_id).'"  >'.stripslashes_deep($fieldOpt['label']).'</label>';
            ...
            $arm_html_cnt .= "</select>";
            $arm_html_cnt .= "<div class='armclear arm_height_1'></div>";
            $arm_html_cnt .= "<span class='arm_temp_sub_plan_error' style='display:none; color: red;'>".esc_html__('Please select atleast one plan', 'ARMember')."</span>";
            $arm_html_cnt .= "<span class='arm_info_text arm_temp_directory_options'>(".esc_html__("Leave blank to display all plan's cards.", 'ARMember').")</span>";
            $arm_html_cnt .= "</div></div>";
                        ...
                        if(!empty($user_plans)) {
                            ...
                            if(!empty($temps)) {
                                ...
                                if(!empty($user_plans) ) {
                                    ...
                                    return do_shortcode($member_card_html. $card_css);
                                }
                            }
                        }
                    }
                                        ...
                                        if(is_array($file_urls) && !empty($file_urls) && $file_urls > 1)
                                        {
                                            ...
                                            foreach($file_urls as $fileurl)
                                            {
                                                ...
                                                if (in_array($file_ext, array('jpg', 'jpeg', 'jpe', 'png', 'bmp', 'tif', 'tiff', 'JPG', 'JPEG', 'JPE', 'PNG', 'BMP', 'TIF', 'TIFF'))) {
                                                    ...
                                                    $files = MEMBERSHIP_IMAGES_URL . '/file_icon.png';
                                                }
        ...
        function arm_profile_directories_list_section_func($arm_profile_template_section,$section, $member_templates, $defaultTemplates,$tempColorSchemes,$tempColorSchemes1,$subs_data)
        {
            ...
            if($section == 'cards')
            {
                ...
                $arm_profile_template_section = '<div class="arm_solid_divider"></div>
                    ...
                    if(!empty($membership_card_template)) {
                        ...
                        <div class="arm_template_content_main_box">
                            ...
                            $arm_profile_template_section .= '<div class="arm_template_content_option_links">
                                <a href="javascript:void(0)" class="arm_mcard_preview_nav armhelptip" title="'. esc_html__('Click to preview', 'ARMember').'" data-slug="'. esc_attr($template['arm_slug']).'" data-id="'. esc_attr($t_id).'"><img src="'. MEMBERSHIP_IMAGES_URL.'/dir_preview_icon.png" alt="" /></a>
                                <a href="javascript:void(0)" class="arm_membership_card_template_edit_link armhelptip" title="'. esc_html__('Edit Template Options', 'ARMember').'" '. $t_link_attr.'><img src="'. MEMBERSHIP_IMAGES_URL.'/dir_edit_icon.png" alt="" /></a>
                                <a href="javascript:void(0)" class="arm_template_delete_link armhelptip" title="'. esc_html__('Delete Template', 'ARMember').'" '. $t_link_attr.' onclick="showConfirmBoxCallback(\''. esc_attr($t_id).'\');"><img src="'. MEMBERSHIP_IMAGES_URL.'/dir_delete_icon.png" alt="" /></a>
                            </div>
                        </div>
            ...
            <div id="arm_add_membership_card_templates" class="arm_add_membership_card_templates">';
                $backToListingIcon = MEMBERSHIP_IMAGES_URL . '/back_to_listing_arrow.png';//phpcs:ignore
                $arm_font_stylin = 'right';
                if (is_rtl()) {
                    $backToListingIcon = MEMBERSHIP_IMAGES_URL . '/back_to_listing_arrow_right.png'; //phpcs:ignore
                ...
                $arm_profile_template_section .= '<form method="POST" class="arm_admin_form arm_add_membership_card_template_form" id="arm_add_membership_card_template_form" onsubmit="return false;" enctype="multipart/form-data">
                    <div class="arm_sticky_top_belt" id="arm_sticky_top_belt">
                        <div class="arm_belt_box arm_template_action_belt">
                            <div class="arm_belt_block">
                                <a href="javascript:void(0)" class="arm_temp_back_to_list armemailaddbtn"><img src="'. $backToListingIcon.'"/>'. esc_html__('Back to listing', 'ARMember').'</a>
                            </div>
                            <div class="arm_belt_block arm_temp_action_btns" align="'.$arm_font_stylin.'">
                                <button type="submit" class="arm_save_btn arm_add_membership_card_template_submit" data-type="arm_card">'. esc_html__('Save', 'ARMember').'</button>
                                <a href="javascript:void(0)" class="arm_membership_card_prv_btn armemailaddbtn" data-type="arm_card">'. esc_html__('Preview', 'ARMember').'</a>
                            </div>
                            <div class="armclear"></div>
                        </div>
                    </div>
            ...
            $arm_profile_template_section .= '<div id="arm_add_profiles_directories_templates" class="arm_add_profiles_directories_templates '. esc_attr($show_directories_templates).'">';
                ...
                $arm_profile_template_section .= '<form method="POST" class="arm_admin_form arm_add_template_form" id="arm_add_template_form" onsubmit="return false;">';
                    ...
                    <div class="arm_sticky_top_belt" id="arm_sticky_top_belt">
                        <div class="arm_belt_box arm_template_action_belt">
                            <div class="arm_belt_block">
                                <a href="'. esc_url($backlist_link).'" class="arm_temp_back_to_list armemailaddbtn"><img src="'. $backToListingIcon .'"/>'. esc_html__('Back to listing', 'ARMember').'</a>
                            </div>
                            <div class="arm_belt_block arm_temp_action_btns" align="'.$arm_font_stylin.'">
                    ...
                    <div class="arm_add_template_options_wrapper">
                        ...
                        <div class="arm_template_option_block">
                            <div class="arm_directory_template_name_div arm_form_fields_wrapper">
                                <label class="arm_opt_title">'. esc_html__('Directory Template Name', 'ARMember').'</label>
                            ...
                            <div class="arm_opt_title">'. esc_html__('Select Template', 'ARMember').'</div>
                            <div class="arm_opt_content">';
                                if (!empty($defaultTemplates)):                                   
                                    $templateTypes = array();
                                    foreach ($defaultTemplates as $temp) {
                        ...
                        <div class="arm_solid_divider"></div>
                        <div class="arm_template_option_block">
                            <div class="arm_opt_title">'. esc_html__('Color Scheme', 'ARMember').'</div>
                            <div class="arm_opt_content">
                                ...
                                <div class="arm_temp_color_options" id="arm_temp_color_options" style="'.$arm_template_custom_css.'">
                                    ...
                                    <div class="arm_custom_color_opts arm_temp_profile_options" '. esc_attr($arm_temp_profile_options).'>
                        ...
                        <div class="arm_solid_divider"></div>
                        <div class="arm_template_option_block">
                            <div class="arm_opt_title">'. esc_html__('Font Settings', 'ARMember').'</div>
                            <div class="arm_opt_content">';
                                $fontOptions = array(
                                    'title_font' => esc_html__('Title Font', 'ARMember'),
                                    'subtitle_font' => esc_html__('Sub Title/Label Font', 'ARMember'),
                                ...
                                foreach ($fontOptions as $key => $value):
                                    $arm_profile_template_section .= '<div class="arm_temp_font_opts_box">
                                        <div class="arm_opt_label">'. esc_html($value).'</div>
						...
						<div class="arm_solid_divider"></div>
						<div class="arm_template_option_block">
							<div class="arm_opt_title">'. esc_html__('Other Options','ARMember').'</div>
							<div class="arm_opt_content">
                                ...
                                <div class="arm_temp_opt_box arm_temp_directory_options">
									<div class="arm_opt_label">'. esc_html__('Redirect To Author Archive Page','ARMember').'</div>
									<div class="arm_opt_content_wrapper">
										<div class="arm_temp_switch_wrapper">
											<div class="armswitch arm_global_setting_switch">
                                            ...
                                            <div class="armclear arm_height_1" ></div>
                                            <span class="arm_info_text arm_width_450" >('. esc_html__("If Author have no any post than user will be redirect to ARMember Profile Page", 'ARMember').')</span>
										</div>
									</div>
								</div>
                                <div class="arm_temp_opt_box arm_temp_directory_options">
								...
								<div class="arm_temp_opt_box arm_temp_directory_options" '. esc_attr($arm_temp_profile_options).'>
                                ...
                                <div class="arm_temp_opt_box arm_temp_profile_options" '. esc_attr($arm_temp_profile_options).'>
								...
								<div class="arm_temp_opt_box arm_subscription_plans_box">
									...
									<div class="arm_opt_content_wrapper">
										...
										<div class="armclear arm_height_1" ></div>
                                        <span class="arm_temp_sub_plan_error arm_color_red" style="display:none;">'. esc_html__('Please select atleast one plan', 'ARMember').'</span>
										<span class="arm_info_text arm_temp_directory_options">('. esc_html__("Leave blank to display all plan's members.", 'ARMember').')</span>
									</div>
								</div>
								                ...
								                if (!empty($socialProfileFields)):
								                    foreach ($socialProfileFields as $spfKey => $spfLabel):
								                        ...
								                        $arm_profile_template_section .= '<div class="arm_social_profile_field_item">
								                           ...
								                           <label for="arm_spf_'. esc_attr($spfKey).'_status">'. esc_html($spfLabel).'</label>
								                        </div>';
                                                    endforeach;
                                                endif;
								                ...
								                if (!empty($dbProfileFields)):
                                                    foreach ($dbProfileFields as $pfKey => $pfLabel):
                                                        ...
                                                        $arm_profile_template_section .= '<div class="arm_profile_search_field_item">
                                                            ...
                                                            <label for="arm_pf_'. esc_attr($pfKey).'_status">'. stripslashes( esc_html($pfLabel['label']) ).'</label>
                                                        </div>';
                                                    endforeach;
                                                endif;
                                            $arm_profile_template_section .= '</div>
                                                ...
                                                if (!empty($arm_display_members_fields)):
                                                    foreach ($arm_display_members_fields as $pfKey => $pfLabel):
                                                        ...
                                                        if(in_array($pfKey, array('arm_display_user_id', 'arm_show_joining_date', 'arm_membership_plan', 'arm_membership_plan_expiry_date')))
                                                        {
                                                            ...
                                                            $arm_profile_template_section .= '<span class="arm_display_member_fields_label ">
                                                        ...
                                                        {                                                       
                                                            $arm_profile_template_section .= '<label for="arm_display_member_field_add_'. esc_attr($pfKey).'_status" >'. stripslashes( esc_attr($pfLabel['label']) ).'</label>';
                                                        }
                                                        $arm_profile_template_section .= '</div>';
                                                    endforeach;
                                                endif;
								...
								<div class="arm_temp_opt_box">
									...
									<div class="arm_opt_content_wrapper">
										...
										<div class="armclear"></div>
										<div class="arm_temp_custom_class arm_temp_profile_options" '. esc_attr($arm_temp_profile_options).'>
