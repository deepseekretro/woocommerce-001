        ...
        function arm_add_nav_menu_metabox(){
            ...
            <style type="text/css">
                ...
                .armformnav .accordion-section-title.hndle:hover, .armlogout .accordion-section-title.hndle:hover, .armsetupnav .accordion-section-title.hndle:hover {
                    background-color: #005aee; color: white; margin: -6px 0 0; position: relative;
                }
                .armformnav .accordion-section-title.hndle::before, .armlogout .accordion-section-title.hndle::before, .armsetupnav .accordion-section-title.hndle::before{
                    background-image: url(<?php echo MEMBERSHIP_IMAGES_URL.'/logo_navmenu_white.png'; //phpcs:ignore ?>); height: 20px; width: 20px; content: " "; 
            ...
            if ($pagenow == 'nav-menus.php') {
                ...
                <style type='text/css'>
                    ...
                    .arm-menu-item-hide-show:before{
                        background-image: url(<?php echo MEMBERSHIP_IMAGES_URL.'/logo_navmenu_white.png'; //phpcs:ignore ?>);
                        height: 20px;
                        width: 20px;
                        content: " ";
                        position: absolute;
